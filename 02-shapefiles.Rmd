...
In _terra_ this has been made extremely easy.
...
R _terra_ has a nice feature that allows to draw on a plot and save the resulting geometry in the environment.
...
When you are done, right click and the output will be saved in the variable _drawing_.

![Example of drawing a line using _terra_ draw().](figures/draw-show.gif)
